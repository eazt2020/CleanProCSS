...
class Tickets extends MY_Controller {
	...
	public function validate()
	{
		...
		if (strpos($powermat,$powerval) !== false) {
			...
			if(isset($_GET['id']) && $_GET['id'] !== 0){$calt = $_GET['id']; $crDate = $_POST['crDate']; $userCr = $_POST['userCr'];}else {$calt = $calt->id + 1; $crDate = time(); $userCr = $userid00;}
